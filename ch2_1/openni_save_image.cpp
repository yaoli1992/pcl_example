...
#include <pcl/io/openni_grabber.h>  //io获取接口头文件
#include <pcl/io/openni_camera/openni_driver.h>   //驱动头文件
#include <pcl/console/parse.h>   //检测命令的头文件
#include <vector>
#include <string>
