...
main(int argc, char** argv)
{
	...
	pcl::PointCloud<pcl::PointXYZRGBA>::Ptr cloudNoPlane(new pcl::PointCloud<pcl::PointXYZRGBA>);
	pcl::PointCloud<pcl::PointXYZRGBA>::Ptr planePoints(new pcl::PointCloud<pcl::PointXYZRGBA>);
	pcl::PointCloud<pcl::PointXYZRGBA>::Ptr projectedPoints(new pcl::PointCloud<pcl::PointXYZRGBA>);
	...
	else
	{
		...
		pcl::ProjectInliers<pcl::PointXYZRGBA> projection;
