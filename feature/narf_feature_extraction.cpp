...
#include <pcl/features/range_image_border_extractor.h>  //边界提取头文件
#include <pcl/keypoints/narf_keypoint.h>          //NARF关键点提取
#include <pcl/features/narf_descriptor.h>           //NARF描述子
