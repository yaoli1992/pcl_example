...
void 
setViewerPose (pcl::visualization::PCLVisualizer& viewer, const Eigen::Affine3f& viewer_pose)  //setViewerPose函数设置深度图像的视点参数
{                                                                                              //也就传感器的位置
...
main (int argc, char** argv)
{
  ...
  // -----------------------------------------------
  // ----从点云数据生成深度图像（要求点云是要有规则有必要信息的点云才可以生成深度图像）-----
  // -----------------------------------------------
  ...
  range_image.createFromPointCloud (point_cloud, angular_resolution_x, angular_resolution_y,
                                    ...
                                    scene_sensor_pose, coordinate_frame, noise_level, min_range, border_size);//从点云生成深度图像的函数
